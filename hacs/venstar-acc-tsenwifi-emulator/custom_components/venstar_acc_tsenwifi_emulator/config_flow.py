"""Config flow for Venstar ACC-TSENWIFI Emulator integration."""
...
class VenstarEmulatorConfigFlow(ConfigFlow, domain=DOMAIN):
    """Handle a config flow for Venstar ACC-TSENWIFI Emulator."""
    ...
    async def async_step_user(
        ...
        if user_input is not None:
            ...
            return self.async_create_entry(
                title="Venstar ACC-TSENWIFI Emulator",
        ...
        return self.async_show_form(
            ...
            description_placeholders={
                "description": (
                    "This will create a Venstar ACC-TSENWIFI Emulator instance. "
    ...
    def async_get_options_flow(
        ...
        return VenstarEmulatorOptionsFlow()


class VenstarEmulatorOptionsFlow(OptionsFlow):
    """Handle options flow for Venstar ACC-TSENWIFI Emulator."""
